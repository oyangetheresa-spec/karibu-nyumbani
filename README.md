...
<!DOCTYPE html>
<html lang="en">
google-site-verification: googlea0e8a479411fdc11.html
<head>
  <meta charset="UTF-8">
  ...
  <style>
    ...
    .fab{
      ...
      z-index:60; border:0; font-size:15px;
...
<body>
  ...
  <section>
    ...
    <div class="grid">
      ...
      <div class="card">✔ Cozy, modern <strong>Studios & 1BRs</strong></div>
      <div class="card">✔ Affordable luxury + quick booking</div>
    </div>
  </section>
  ...
  <section>
    <h2>Amenities</h2>
    <div class="grid">
      <div class="card">WiFi & Smart TV</div>
      <div class="card">Secure Parking</div>
      <div class="card">Fully Equipped Kitchen</div>
  ...
  <footer>
    <p>📍 Karibu Nyumbani – Ngong Road, Nairobi</p>
    <p>Contact: <a href="https://wa.me/254757942317" style="color:#fff;text-decoration:underline;">WhatsApp Us</a></p>
  </footer>

  <!-- Floating WhatsApp button -->
  <a class="fab" href="https://wa.me/254757942317?text=Hi!%20I'd%20like%20to%20book%20Karibu%20Nyumbani%20from%20[check-in]%20to%20[check-out]." target="_blank">💬 Chat on WhatsApp</a>
